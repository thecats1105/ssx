#   Scoop Super Search v7.1.2 2025.05.03
...
function ss {
    ...
    if (($oHelp) -OR (!$oRaw)) {
        Write-Host " Scoop Super Search v7.1.2 2025.05.03
 ...
 Examples:
    ...
    $checksum = curl -sL https://github.com/thecats1105/ScoopMaster/releases/download/Databases/checksum.json | ConvertFrom-Json
